...
public class ColorBottomSheetBehavior<V extends View> extends BottomSheetBehavior<V> {
    ...
    private boolean B;
    private ColorBottomSheetBehavior<V>.b C = null;
    ...
    private final c.a S = new c.a() {
        public boolean tryCaptureView(View view, int i) {
            if (ColorBottomSheetBehavior.this.h == 1 || ColorBottomSheetBehavior.this.o) {
                return false;
            }
            if (ColorBottomSheetBehavior.this.h == 3 && ColorBottomSheetBehavior.this.n == i) {
                View view2 = ColorBottomSheetBehavior.this.m != null ? (View) ColorBottomSheetBehavior.this.m.get() : null;
                if (view2 != null && view2.canScrollVertically(-1)) {
                    return false;
                }
            }
            if (ColorBottomSheetBehavior.this.l == null || ColorBottomSheetBehavior.this.l.get() != view) {
                return false;
            }
            return true;
        }
        ...
        public void onViewPositionChanged(View view, int i, int i2, int i3, int i4) {
            ColorBottomSheetBehavior.this.dispatchOnSlide(i2);
        }

        public void onViewDragStateChanged(int i) {
            if (i == 1 && ColorBottomSheetBehavior.this.G) {
                ColorBottomSheetBehavior.this.setStateInternal(1);
            }
        }

        private boolean a(View view) {
            return view.getTop() > (ColorBottomSheetBehavior.this.k + ColorBottomSheetBehavior.this.getExpandedOffset()) / 2;
        }
        ...
        public void onViewReleased(View view, float f, float f2) {
            ...
            int i4;
            int i5;
            if (ColorBottomSheetBehavior.this.P == null || ColorBottomSheetBehavior.this.k - view.getHeight() >= ColorBottomSheetBehavior.this.getExpandedOffset() || view.getTop() >= ColorBottomSheetBehavior.this.getExpandedOffset()) {
                int i6 = 5;
                int i7 = 3;
                if (f2 >= 0.0f) {
                    if (!ColorBottomSheetBehavior.this.g || !ColorBottomSheetBehavior.this.shouldHide(view, f2)) {
                        if (f2 == 0.0f || Math.abs(f) > Math.abs(f2)) {
                            int top = view.getTop();
                            if (ColorBottomSheetBehavior.this.r) {
                                if (Math.abs(top - ColorBottomSheetBehavior.this.f1883b) < Math.abs(top - ColorBottomSheetBehavior.this.e)) {
                                    i4 = ColorBottomSheetBehavior.this.f1883b;
                                    i6 = 3;
                                    i7 = i6;
                                    ColorBottomSheetBehavior.this.startSettlingAnimation(view, i7, i, true);
                                    return;
                                }
                                i2 = ColorBottomSheetBehavior.this.e;
                            } else if (top < ColorBottomSheetBehavior.this.c) {
                                if (top < Math.abs(top - ColorBottomSheetBehavior.this.e)) {
                                    i4 = ColorBottomSheetBehavior.this.f1882a;
                                    i6 = 3;
                                    i7 = i6;
                                    ColorBottomSheetBehavior.this.startSettlingAnimation(view, i7, i, true);
                                    return;
                                }
                                i3 = ColorBottomSheetBehavior.this.c;
                            } else if (Math.abs(top - ColorBottomSheetBehavior.this.c) < Math.abs(top - ColorBottomSheetBehavior.this.e)) {
                                i3 = ColorBottomSheetBehavior.this.c;
                            } else {
                                i2 = ColorBottomSheetBehavior.this.e;
                            }
                        ...
                        if (!ColorBottomSheetBehavior.this.r) {
                            ...
                            if (Math.abs(top2 - ColorBottomSheetBehavior.this.c) < Math.abs(top2 - ColorBottomSheetBehavior.this.e)) {
                                i = ColorBottomSheetBehavior.this.c;
                            } else {
                                i5 = ColorBottomSheetBehavior.this.e;
                            }
                        } else if (ColorBottomSheetBehavior.this.p == null) {
                            i5 = ColorBottomSheetBehavior.this.e;
                        } else if (ColorBottomSheetBehavior.this.p.a()) {
                            i = ColorBottomSheetBehavior.this.f1883b;
                            ColorBottomSheetBehavior.this.startSettlingAnimation(view, i7, i, true);
                            return;
                        } else {
                            i4 = ColorBottomSheetBehavior.this.k;
                            i7 = i6;
                            ColorBottomSheetBehavior.this.startSettlingAnimation(view, i7, i, true);
                            return;
                        }
                        ...
                        ColorBottomSheetBehavior.this.startSettlingAnimation(view, i7, i, true);
                        return;
                    } else if (ColorBottomSheetBehavior.this.p != null && ColorBottomSheetBehavior.this.p.a()) {
                        i = ColorBottomSheetBehavior.this.f1883b;
                        boolean unused = ColorBottomSheetBehavior.this.R = false;
                        ColorBottomSheetBehavior.this.startSettlingAnimation(view, i7, i, true);
                        return;
                    } else if ((Math.abs(f) >= Math.abs(f2) || f2 <= 500.0f) && !a(view)) {
                        if (ColorBottomSheetBehavior.this.r) {
                            i = ColorBottomSheetBehavior.this.f1883b;
                        } else if (Math.abs(view.getTop() - ColorBottomSheetBehavior.this.f1882a) < Math.abs(view.getTop() - ColorBottomSheetBehavior.this.c)) {
                            i = ColorBottomSheetBehavior.this.f1882a;
                        } else {
                            i = ColorBottomSheetBehavior.this.c;
                        }
                        ColorBottomSheetBehavior.this.startSettlingAnimation(view, i7, i, true);
                        ...
                        i4 = ColorBottomSheetBehavior.this.k;
                        boolean unused2 = ColorBottomSheetBehavior.this.R = true;
                        i7 = i6;
                        ColorBottomSheetBehavior.this.startSettlingAnimation(view, i7, i, true);
                        return;
                    }
                    ...
                    ColorBottomSheetBehavior.this.startSettlingAnimation(view, i7, i, true);
                    return;
                } else if (ColorBottomSheetBehavior.this.r) {
                    i = ColorBottomSheetBehavior.this.f1883b;
                    ColorBottomSheetBehavior.this.startSettlingAnimation(view, i7, i, true);
                    return;
                } else if (view.getTop() > ColorBottomSheetBehavior.this.c) {
                    i3 = ColorBottomSheetBehavior.this.c;
                } else {
                    i4 = ColorBottomSheetBehavior.this.f1882a;
                    i6 = 3;
            ...
            ColorBottomSheetBehavior.this.P.a(ColorBottomSheetBehavior.this.getExpandedOffset());
        }

        public int clampViewPositionVertical(View view, int i, int i2) {
            int i3 = 0;
            if (ColorBottomSheetBehavior.this.P != null) {
                if (ColorBottomSheetBehavior.this.h == 1 && view.getTop() <= ColorBottomSheetBehavior.this.getExpandedOffset()) {
                    boolean unused = ColorBottomSheetBehavior.this.Q = true;
                    i3 = ColorBottomSheetBehavior.this.P.a(i2, ColorBottomSheetBehavior.this.getExpandedOffset());
                }
            }
            return androidx.core.b.a.a(i, ColorBottomSheetBehavior.this.getExpandedOffset() - i3, ColorBottomSheetBehavior.this.g ? ColorBottomSheetBehavior.this.k : ColorBottomSheetBehavior.this.e);
        }
        ...
        public int getViewVerticalDragRange(View view) {
            if (ColorBottomSheetBehavior.this.g) {
                return ColorBottomSheetBehavior.this.k;
            }
            return ColorBottomSheetBehavior.this.e;
        }
    };
    ...
    public Parcelable onSaveInstanceState(CoordinatorLayout coordinatorLayout, V v2) {
        return new SavedState(super.onSaveInstanceState(coordinatorLayout, v2), (ColorBottomSheetBehavior<?>) this);
    }
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, V v2, int i2) {
        ...
        if (!this.Q) {
            this.f1883b = Math.max(0, this.k - v2.getHeight());
        }
        this.Q = false;
        d();
        c();
    ...
    public boolean onInterceptTouchEvent(androidx.coordinatorlayout.widget.CoordinatorLayout r10, V r11, android.view.MotionEvent r12) {
        ...
        L_0x0079:
            ...
            int r4 = r9.M
            int r6 = r9.N
            boolean r11 = r10.isPointInChildBounds(r11, r4, r6)
        ...
        L_0x0102:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.color.support.dialog.panel.ColorBottomSheetBehavior.onInterceptTouchEvent(androidx.coordinatorlayout.widget.CoordinatorLayout, android.view.View, android.view.MotionEvent):boolean");
    }
    ...
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, V v2, View view, int i2) {
        ...
        if (weakReference != null && view == weakReference.get() && this.J) {
            if (this.I > 0) {
                ...
                startSettlingAnimation(v2, i6, i3, false);
                this.J = false;
            }
            if (!this.g || !shouldHide(v2, g())) {
                if (this.I == 0) {
                    int top2 = v2.getTop();
                    if (!this.r) {
                        int i8 = this.c;
                        if (top2 < i8) {
                            ...
                            i5 = this.c;
                        } else if (Math.abs(top2 - i8) < Math.abs(top2 - this.e)) {
                            i5 = this.c;
                        } else {
                            i4 = this.e;
                        }
                    } else if (Math.abs(top2 - this.f1883b) < Math.abs(top2 - this.e)) {
                        i3 = this.f1883b;
                        startSettlingAnimation(v2, i6, i3, false);
                        this.J = false;
                    } else {
    ...
    private void a(int r4, boolean r5) {
        ...
        L_0x0042:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.color.support.dialog.panel.ColorBottomSheetBehavior.a(int, boolean):void");
    }
    ...
    public int getExpandedOffset() {
        return this.r ? this.f1883b : this.f1882a;
    }
        ...
        if (view != null) {
            ...
            if (parent == null || !parent.isLayoutRequested() || !v.D(view)) {
                ...
                view.post(new Runnable() {
                    public void run() {
                        ColorBottomSheetBehavior.this.settleToState(view, i2);
                    }
                });
            }
        }
    ...
    private void c() {
        int b2 = b();
        if (this.r) {
            this.e = Math.max(this.k - b2, this.f1883b);
        } else {
            this.e = this.k - b2;
        }
    }
    ...
    public boolean shouldHide(View view, float f2) {
        ...
        if (Math.abs((((float) view.getTop()) + (f2 * 0.1f)) - ((float) this.e)) / ((float) b()) > 0.5f) {
            return true;
        }
        return false;
    }
    ...
    private void f() {
        ...
        this.D.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                if (ColorBottomSheetBehavior.this.y != null) {
                    ColorBottomSheetBehavior.this.y.setInterpolation(floatValue);
                }
            }
        });
    }
    ...
    public void startSettlingAnimation(View view, int i2, int i3, boolean z2) {
        ...
        if (z3) {
            ...
            if (!this.C.d) {
                ColorBottomSheetBehavior<V>.b bVar = this.C;
                bVar.f1890a = i2;
    ...
    private class b implements Runnable {
        ...
        public void run() {
            if (ColorBottomSheetBehavior.this.i == null || !ColorBottomSheetBehavior.this.i.a(true)) {
                ColorBottomSheetBehavior.this.setStateInternal(this.f1890a);
            } else {
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable parcelable, ColorBottomSheetBehavior<?> colorBottomSheetBehavior) {
            super(parcelable);
            this.state = colorBottomSheetBehavior.h;
            this.peekHeight = colorBottomSheetBehavior.u;
            this.fitToContents = colorBottomSheetBehavior.r;
            this.hideable = colorBottomSheetBehavior.g;
            this.skipCollapsed = colorBottomSheetBehavior.F;
        }
    ...
    private void a(V v2, d.a aVar, final int i2) {
        v.a(v2, aVar, (CharSequence) null, new g() {
            public boolean perform(View view, g.a aVar) {
                ColorBottomSheetBehavior.this.b(i2);
                return true;
            }
        });
    }
