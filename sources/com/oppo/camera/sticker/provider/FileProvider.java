...
public class FileProvider extends ContentProvider {
    ...
    private static final String[] f3669a = {"_display_name", "_size"};

    /* renamed from: b  reason: collision with root package name */
    private static final File f3670b = new File("/");
    ...
    public java.lang.String getType(android.net.Uri r3) {
        /*
            r2 = this;
            com.oppo.camera.sticker.provider.FileProvider$a r0 = r2.d
        ...
        L_0x0027:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oppo.camera.sticker.provider.FileProvider.getType(android.net.Uri):java.lang.String");
    }
    ...
    static class b implements a {
        ...
        /* renamed from: b  reason: collision with root package name */
        private final HashMap<String, File> f3672b = new HashMap<>();
        ...
        public void a(String str, File file) {
            if (!TextUtils.isEmpty(str)) {
                try {
                    this.f3672b.put(str, file.getCanonicalFile());
                } catch (IOException e) {
        ...
        public Uri a(File file) {
            ...
            try {
                ...
                for (Map.Entry next : this.f3672b.entrySet()) {
                ...
                if (entry != null) {
                    ...
                    return new Uri.Builder().scheme("content").authority(this.f3671a).encodedPath(Uri.encode((String) entry.getKey()) + '/' + Uri.encode(str, "/")).build();
                }
        ...
        public File a(Uri uri) {
            ...
            File file = this.f3672b.get(decode);
            if (file != null) {
