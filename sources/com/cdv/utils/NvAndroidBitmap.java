            ...
            if (size2 != null) {
                if (!size2.equals(size)) {
                    if (i != 0) {
                        ...
                        if (i == 1) {
                            size3 = width >= width2 ? new Size(size2.getWidth(), (int) ((((double) size2.getWidth()) / width) + 0.5d)) : new Size((int) ((((double) size2.getHeight()) * width) + 0.5d), size2.getHeight());
                        } else {
                            size3 = width >= width2 ? new Size((int) ((((double) size2.getHeight()) * width) + 0.5d), size2.getHeight()) : new Size(size2.getWidth(), (int) ((((double) size2.getWidth()) / width) + 0.5d));
                        }
                    } else {
                        size3 = size2;
                    }
