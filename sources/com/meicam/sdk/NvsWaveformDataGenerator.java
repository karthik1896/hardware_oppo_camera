...
public class NvsWaveformDataGenerator {
    ...
    public long generateWaveformData(String str, long j, long j2, long j3, int i) {
        ...
        long j5 = nativeGetAudioFileSampleCount;
        ...
        Task task = new Task();
        long j6 = this.m_nextTaskId;
        this.m_nextTaskId = 1 + j6;
        task.taskId = j6;
        task.waveformTaskId = nativeFetchWaveformData;
        task.m_audioFilePath = str2;
        task.m_audioFileSampleCount = j5;
        long unused = task.m_samplesPerGroup = j4;
