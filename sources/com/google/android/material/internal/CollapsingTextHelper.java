...
public final class CollapsingTextHelper {
    ...
    private void calculateBaseOffsets() {
        ...
        int a2 = c.a(this.collapsedTextGravity, this.isRtl ? 1 : 0);
        ...
        int a3 = c.a(this.expandedTextGravity, this.isRtl ? 1 : 0);
        int i3 = a3 & 112;
        if (i3 == 48) {
    ...
    private boolean calculateIsRtl(CharSequence charSequence) {
        return (isDefaultIsRtl() ? e.d : e.c).a(charSequence, 0, charSequence.length());
    }

    private boolean isDefaultIsRtl() {
        return v.g(this.view) == 1;
    }
