...
final class StaticLayoutBuilderCompat {
    ...
    public StaticLayout build() throws StaticLayoutBuilderCompatException {
        ...
        try {
            return (StaticLayout) ((Constructor) f.a(constructor)).newInstance(new Object[]{charSequence, Integer.valueOf(this.start), Integer.valueOf(this.end), this.paint, Integer.valueOf(max), this.alignment, f.a(textDirection), Float.valueOf(1.0f), Float.valueOf(0.0f), Boolean.valueOf(this.includePad), null, Integer.valueOf(max), Integer.valueOf(this.maxLines)});
        } catch (Exception e) {
