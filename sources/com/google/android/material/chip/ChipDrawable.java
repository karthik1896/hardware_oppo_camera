...
public class ChipDrawable extends MaterialShapeDrawable implements Drawable.Callback, b, TextDrawableHelper.TextDrawableDelegate {
    ...
    private void drawDebug(Canvas canvas, Rect rect) {
        Paint paint = this.debugPaint;
        if (paint != null) {
            paint.setColor(d.b(-16777216, 127));
            ...
            this.debugPaint.setColor(d.b(-65536, 127));
            calculateChipTouchBounds(rect, this.rectF);
            canvas.drawRect(this.rectF, this.debugPaint);
            this.debugPaint.setColor(d.b(-16711936, 127));
    ...
    public boolean onLayoutDirectionChanged(int i) {
        ...
        if (showsChipIcon()) {
            onLayoutDirectionChanged |= a.b(this.chipIcon, i);
        }
        if (showsCheckedIcon()) {
            onLayoutDirectionChanged |= a.b(this.checkedIcon, i);
        }
        if (showsCloseIcon()) {
            onLayoutDirectionChanged |= a.b(this.closeIcon, i);
        }
    ...
    private void applyChildDrawable(Drawable drawable) {
        if (drawable != null) {
            ...
            if (drawable == drawable2 && this.hasChipIconTint) {
                a.a(drawable2, this.chipIconTint);
            }
        }
    }
    ...
    public void setChipIcon(Drawable drawable) {
        ...
        if (chipIcon2 != drawable) {
            float calculateChipIconWidth = calculateChipIconWidth();
            this.chipIcon = drawable != null ? a.g(drawable).mutate() : null;
    ...
    public void setCloseIcon(Drawable drawable) {
        ...
        if (closeIcon2 != drawable) {
            ...
            this.closeIcon = drawable != null ? a.g(drawable).mutate() : null;
            if (RippleUtils.USE_FRAMEWORK_RIPPLE) {
    ...
    public void setCloseIconContentDescription(CharSequence charSequence) {
        if (this.closeIconContentDescription != charSequence) {
            this.closeIconContentDescription = androidx.core.e.a.a().a(charSequence);
            invalidateSelf();
        }
    }
    ...
    public void setCheckedIconTint(ColorStateList colorStateList) {
        if (this.checkedIconTint != colorStateList) {
            ...
            if (canShowCheckedIcon()) {
                a.a(this.checkedIcon, colorStateList);
            }
            onStateChange(getState());
        }
    }
