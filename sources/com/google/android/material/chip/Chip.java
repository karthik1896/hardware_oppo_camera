...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        createFromAttributes.setElevation(v.o(this));
        ...
        this.lastLayoutDirection = v.g(this);
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (getParent() instanceof ChipGroup) {
            ...
            d.a(accessibilityNodeInfo).b((Object) d.c.a(chipGroup.getRowIndex(this), 1, chipGroup.isSingleLine() ? chipGroup.getIndexOfChip(this) : -1, 1, false, isChecked()));
        }
    }

    private void updateAccessibilityDelegate() {
        if (!hasCloseIcon() || !isCloseIconVisible() || this.onCloseIconClickListener == null) {
            v.a((View) this, (a) null);
        } else {
            v.a((View) this, (a) this.touchHelper);
        }
    }
    ...
    private void updatePaddingInternal() {
        ...
        if (!TextUtils.isEmpty(getText()) && (chipDrawable2 = this.chipDrawable) != null) {
            ...
            v.b(this, chipStartPadding, getPaddingTop(), chipEndPadding, getPaddingBottom());
        }
    }
    ...
    private void updateFrameworkRippleBackground() {
        ...
        v.a((View) this, (Drawable) this.ripple);
        updatePaddingInternal();
    }
        ...
        if (motionEvent.getAction() == 10) {
            try {
                ...
                if (((Integer) declaredField.get(this.touchHelper)).intValue() != Integer.MIN_VALUE) {
                    Method declaredMethod = androidx.customview.a.a.class.getDeclaredMethod("updateHoveredVirtualView", new Class[]{Integer.TYPE});
    ...
    public PointerIcon onResolvePointerIcon(MotionEvent motionEvent, int i) {
        ...
        return PointerIcon.getSystemIcon(getContext(), TouchlessA3D.Parameters.EXTENDED_RANGE);
    }

    private class ChipTouchHelper extends androidx.customview.a.a {
        ...
        public void onPopulateNodeForVirtualView(int i, d dVar) {
            if (i == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    objArr[0] = text;
                    dVar.e((CharSequence) context.getString(i2, objArr).trim());
                }
                dVar.b(Chip.this.getCloseIconTouchBoundsInt());
                dVar.a(d.a.e);
                dVar.i(Chip.this.isEnabled());
                return;
            }
            dVar.e((CharSequence) "");
        ...
        public void onPopulateNodeForHost(d dVar) {
            dVar.a(Chip.this.isCheckable());
            dVar.h(Chip.this.isClickable());
            if (Chip.this.isCheckable() || Chip.this.isClickable()) {
                dVar.b((CharSequence) Chip.this.isCheckable() ? Chip.COMPOUND_BUTTON_ACCESSIBILITY_CLASS_NAME : Chip.BUTTON_ACCESSIBILITY_CLASS_NAME);
            } else {
                dVar.b((CharSequence) Chip.GENERIC_VIEW_ACCESSIBILITY_CLASS_NAME);
            }
            CharSequence text = Chip.this.getText();
            if (Build.VERSION.SDK_INT >= 23) {
                dVar.c(text);
