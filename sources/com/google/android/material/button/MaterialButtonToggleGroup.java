...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        v.a((View) materialButton, (a) new a() {
            public void onInitializeAccessibilityNodeInfo(View view, d dVar) {
                ...
                dVar.b((Object) d.c.a(0, 1, MaterialButtonToggleGroup.this.getIndexWithinVisibleButtons(view), 1, false, ((MaterialButton) view).isChecked()));
            }
        });
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        d.a(accessibilityNodeInfo).a((Object) d.b.a(1, getVisibleButtonCount(), false, isSingleSelection() ? 1 : 2));
    }
    ...
    private void adjustChildMarginsAndUpdateLayout() {
        ...
        if (firstVisibleChildIndex != -1) {
            for (int i = firstVisibleChildIndex + 1; i < getChildCount(); i++) {
                ...
                if (getOrientation() == 0) {
                    f.b(buildLayoutParams, 0);
                    f.a(buildLayoutParams, -min);
                } else {
