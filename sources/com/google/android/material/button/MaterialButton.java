...
public class MaterialButton extends f implements Checkable, Shapeable {
    ...
    private void updateIconPosition() {
        if (this.icon != null && getLayout() != null) {
            ...
            int measuredWidth = (((((getMeasuredWidth() - min) - v.k(this)) - i2) - this.iconPadding) - v.j(this)) / 2;
    ...
    private void updateIcon(boolean z) {
        ...
        boolean z2 = false;
        if (drawable != null) {
            this.icon = androidx.core.graphics.drawable.a.g(drawable).mutate();
            androidx.core.graphics.drawable.a.a(this.icon, this.iconTint);
    ...
    private void resetIconDrawable(boolean z) {
        if (z) {
            i.a(this, this.icon, (Drawable) null, (Drawable) null, (Drawable) null);
        } else {
            i.a(this, (Drawable) null, (Drawable) null, this.icon, (Drawable) null);
        }
    }
