...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    protected BaseTransientBottomBar(ViewGroup viewGroup, View view2, ContentViewCallback contentViewCallback2) {
        if (viewGroup == null) {
            ...
            v.d((View) this.view, 1);
            v.b((View) this.view, 1);
            v.b((View) this.view, true);
            v.a((View) this.view, (q) new q() {
                public ad onApplyWindowInsets(View view, ad adVar) {
                    int unused = BaseTransientBottomBar.this.extraBottomMarginWindowInset = adVar.d();
                    int unused2 = BaseTransientBottomBar.this.extraLeftMarginWindowInset = adVar.a();
                    int unused3 = BaseTransientBottomBar.this.extraRightMarginWindowInset = adVar.c();
                    BaseTransientBottomBar.this.updateMargins();
                    return adVar;
                }
            });
            v.a((View) this.view, (a) new a() {
    ...
    private boolean isSwipeDismissable() {
        ViewGroup.LayoutParams layoutParams = this.view.getLayoutParams();
        return (layoutParams instanceof CoordinatorLayout.e) && (((CoordinatorLayout.e) layoutParams).b() instanceof SwipeDismissBehavior);
    }
    ...
    public void startSlideInAnimation() {
        ...
        if (USE_OFFSET_API) {
            v.e(this.view, translationYBottom);
        } else {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                if (BaseTransientBottomBar.USE_OFFSET_API) {
                    v.e(BaseTransientBottomBar.this.view, intValue - this.previousAnimatedIntValue);
                } else {
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        protected SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            if (getBackground() == null) {
                v.a((View) this, createThemedBackground());
            }
        }
        ...
        public void setBackgroundDrawable(Drawable drawable) {
            if (!(drawable == null || this.backgroundTint == null)) {
                ...
                androidx.core.graphics.drawable.a.a(drawable, this.backgroundTintMode);
            }
        ...
        public void setBackgroundTintList(ColorStateList colorStateList) {
            ...
            if (getBackground() != null) {
                ...
                androidx.core.graphics.drawable.a.a(g, this.backgroundTintMode);
                if (g != getBackground()) {
        ...
        private Drawable createThemedBackground() {
            ...
            androidx.core.graphics.drawable.a.a(g, this.backgroundTint);
            return g;
        }
    }
