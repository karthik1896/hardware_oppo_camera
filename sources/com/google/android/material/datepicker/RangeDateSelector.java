...
public class RangeDateSelector implements DateSelector<d<Long, Long>> {
    ...
    public void setSelection(d<Long, Long> dVar) {
        Long l;
        if (!(dVar.f676a == null || dVar.f677b == null)) {
            f.a(isValidRange(((Long) dVar.f676a).longValue(), ((Long) dVar.f677b).longValue()));
        }
        Long l2 = null;
        if (dVar.f676a == null) {
            l = null;
        } else {
            l = Long.valueOf(UtcDates.canonicalYearMonthDay(((Long) dVar.f676a).longValue()));
        }
        this.selectedStartItem = l;
        if (dVar.f677b != null) {
            l2 = Long.valueOf(UtcDates.canonicalYearMonthDay(((Long) dVar.f677b).longValue()));
        }
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        d<String, String> dateRangeString = DateStrings.getDateRangeString(l2, l);
        return resources.getString(R.string.mtrl_picker_range_header_selected, new Object[]{dateRangeString.f676a, dateRangeString.f677b});
    }
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints calendarConstraints, OnSelectionChangedListener<d<Long, Long>> onSelectionChangedListener) {
        ...
        final OnSelectionChangedListener<d<Long, Long>> onSelectionChangedListener2 = onSelectionChangedListener;
    ...
    /* access modifiers changed from: private */
    public void updateIfValidTextProposal(TextInputLayout textInputLayout, TextInputLayout textInputLayout2, OnSelectionChangedListener<d<Long, Long>> onSelectionChangedListener) {
