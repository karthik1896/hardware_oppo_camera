...
final class MaterialCalendarGridView extends GridView {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        for (androidx.core.f.d next : dateSelector.getSelectedRanges()) {
            if (next.f676a != null) {
                if (next.f677b == null) {
                    continue;
                } else {
                    long longValue = ((Long) next.f676a).longValue();
                    long longValue2 = ((Long) next.f677b).longValue();
