...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (!MaterialDatePicker.isFullscreen(contextThemeWrapper)) {
            new k().a(this.recyclerView);
        }
        this.recyclerView.scrollToPosition(monthsPagerAdapter.getPosition(this.current));
        return inflate;
    }

    private RecyclerView.h createItemDecoration() {
        return new RecyclerView.h() {
            ...
            public void onDraw(Canvas canvas, RecyclerView recyclerView, RecyclerView.t tVar) {
                ...
                if ((recyclerView.getAdapter() instanceof YearGridAdapter) && (recyclerView.getLayoutManager() instanceof GridLayoutManager)) {
                    ...
                    for (androidx.core.f.d next : MaterialCalendar.this.dateSelector.getSelectedRanges()) {
                        if (!(next.f676a == null || next.f677b == null)) {
                            this.startItem.setTimeInMillis(((Long) next.f676a).longValue());
                            this.endItem.setTimeInMillis(((Long) next.f677b).longValue());
                            ...
                            int a2 = positionForYear / gridLayoutManager.a();
                            int a3 = positionForYear2 / gridLayoutManager.a();
                            int i2 = a2;
                            while (i2 <= a3) {
    ...
    private void addActionsToMonthNavigation(View view, final MonthsPagerAdapter monthsPagerAdapter) {
        ...
        v.a((View) materialButton, (a) new a() {
            public void onInitializeAccessibilityNodeInfo(View view, d dVar) {
                String str;
                super.onInitializeAccessibilityNodeInfo(view, dVar);
        ...
        this.recyclerView.addOnScrollListener(new RecyclerView.n() {
