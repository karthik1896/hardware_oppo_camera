...
public final class MaterialDatePicker<S> extends b {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        this.background.setElevation(v.o(dialog.getWindow().getDecorView()));
        return dialog;
    }
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        v.d((View) this.headerSelectionText, 1);
    ...
    public void startPickerFragment() {
        ...
        a2.a(R.id.mtrl_calendar_frame, (Fragment) this.pickerFragment);
        a2.d();
    ...
    private void initHeaderToggle(Context context) {
        ...
        v.a((View) this.headerToggleButton, (a) null);
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{16842912}, androidx.appcompat.a.a.a.b(context, R.drawable.material_ic_calendar_black_24dp));
