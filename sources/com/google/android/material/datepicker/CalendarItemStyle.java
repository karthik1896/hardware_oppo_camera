...
final class CalendarItemStyle {
    ...
    static CalendarItemStyle create(Context context, int i) {
        f.a(i != 0, (Object) "Cannot create a CalendarItemStyle with a styleResId of 0");
    ...
    public void styleItem(TextView textView) {
        ...
        v.a((View) textView, (Drawable) new InsetDrawable(Build.VERSION.SDK_INT >= 21 ? new RippleDrawable(this.textColor.withAlpha(30), materialShapeDrawable, materialShapeDrawable2) : materialShapeDrawable, this.insets.left, this.insets.top, this.insets.right, this.insets.bottom));
    }
