...
class FloatingActionButtonImpl {
    ...
    public void initializeBackgroundDrawable(ColorStateList colorStateList, PorterDuff.Mode mode, ColorStateList colorStateList2, int i) {
        ...
        this.contentBackground = new LayerDrawable(new Drawable[]{(Drawable) f.a(this.shapeDrawable), rippleDrawableCompat});
    }
    ...
    public void setRippleColor(ColorStateList colorStateList) {
        ...
        if (drawable != null) {
            a.a(drawable, RippleUtils.sanitizeRippleDrawableColor(colorStateList));
        }
    }
    ...
    private MotionSpec getDefaultShowMotionSpec() {
        ...
        return (MotionSpec) f.a(this.defaultShowMotionSpec);
    }
    ...
    private MotionSpec getDefaultHideMotionSpec() {
        ...
        return (MotionSpec) f.a(this.defaultHideMotionSpec);
    }
    ...
    public void onPaddingUpdated(Rect rect) {
        f.a(this.contentBackground, (Object) "Didn't initialize content background");
        if (shouldAddPadding()) {
    ...
    public MaterialShapeDrawable createShapeDrawable() {
        return new MaterialShapeDrawable((ShapeAppearanceModel) f.a(this.shapeAppearance));
    }
    ...
    private boolean shouldAnimateVisibilityChange() {
        return v.A(this.view) && !this.view.isInEditMode();
    }
