...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    public void initializeBackgroundDrawable(ColorStateList colorStateList, PorterDuff.Mode mode, ColorStateList colorStateList2, int i) {
        ...
        if (i > 0) {
            ...
            drawable = new LayerDrawable(new Drawable[]{(Drawable) f.a(this.borderDrawable), (Drawable) f.a(this.shapeDrawable)});
        } else {
    ...
    public BorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        BorderDrawable borderDrawable = new BorderDrawable((ShapeAppearanceModel) f.a(this.shapeAppearance));
        borderDrawable.setGradientColors(a.c(context, R.color.design_fab_stroke_top_outer_color), a.c(context, R.color.design_fab_stroke_top_inner_color), a.c(context, R.color.design_fab_stroke_end_inner_color), a.c(context, R.color.design_fab_stroke_end_outer_color));
    ...
    public MaterialShapeDrawable createShapeDrawable() {
        return new AlwaysStatefulMaterialShapeDrawable((ShapeAppearanceModel) f.a(this.shapeAppearance));
    }
