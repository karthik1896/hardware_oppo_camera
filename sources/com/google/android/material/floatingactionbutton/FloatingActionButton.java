...
public class FloatingActionButton extends VisibilityAwareImageButton implements CoordinatorLayout.a, u, l, ExpandableTransformationWidget, Shapeable {
    ...
    public ShapeAppearanceModel getShapeAppearanceModel() {
        return (ShapeAppearanceModel) f.a(getImpl().getShapeAppearance());
    }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.expandableWidgetHelper.onRestoreInstanceState((Bundle) f.a(extendableSavedState.extendableStates.get(EXPANDABLE_WIDGET_HELPER_KEY)));
    }
    ...
    protected static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.b<T> {
        ...
        private boolean shouldUpdateVisibility(View view, FloatingActionButton floatingActionButton) {
            ...
            if (this.autoHideEnabled && eVar.a() == view.getId() && floatingActionButton.getUserSetVisibility() == 0) {
                return true;
            }
            return false;
        }
