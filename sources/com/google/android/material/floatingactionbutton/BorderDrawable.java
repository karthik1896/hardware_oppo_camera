...
class BorderDrawable extends Drawable {
    ...
    private Shader createGradientShader() {
        ...
        return new LinearGradient(0.0f, (float) rect2.top, 0.0f, (float) rect2.bottom, new int[]{d.a(this.topOuterStrokeColor, this.currentBorderTintColor), d.a(this.topInnerStrokeColor, this.currentBorderTintColor), d.a(d.b(this.topInnerStrokeColor, 0), this.currentBorderTintColor), d.a(d.b(this.bottomInnerStrokeColor, 0), this.currentBorderTintColor), d.a(this.bottomInnerStrokeColor, this.currentBorderTintColor), d.a(this.bottomOuterStrokeColor, this.currentBorderTintColor)}, new float[]{0.0f, height, 0.5f, 0.5f, 1.0f - height, 1.0f}, Shader.TileMode.CLAMP);
    }
