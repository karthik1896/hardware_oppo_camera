...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.a {
    ...
    static final Property<View, Float> HEIGHT = new Property<View, Float>(Float.class, CameraStatisticsUtil.IMAGE_HEIGHT) {
    ...
    static final Property<View, Float> WIDTH = new Property<View, Float>(Float.class, CameraStatisticsUtil.IMAGE_WIDTH) {
        public void set(View view, Float f) {
    ...
    private boolean shouldAnimateVisibilityChange() {
        return v.A(this) && !isInEditMode();
    }

    /* access modifiers changed from: package-private */
    public int getCollapsedSize() {
        return (Math.min(v.j(this), v.k(this)) * 2) + getIconSize();
    }
    ...
    protected static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.b<T> {
        ...
        private boolean shouldUpdateVisibility(View view, ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            if ((this.autoHideEnabled || this.autoShrinkEnabled) && eVar.a() == view.getId()) {
                return true;
            }
            return false;
        }
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public AnimatorSet createAnimator() {
            ...
            if (currentMotionSpec.hasPropertyValues(CameraStatisticsUtil.IMAGE_WIDTH)) {
                PropertyValuesHolder[] propertyValues = currentMotionSpec.getPropertyValues(CameraStatisticsUtil.IMAGE_WIDTH);
                propertyValues[0].setFloatValues(new float[]{(float) ExtendedFloatingActionButton.this.getWidth(), (float) this.size.getWidth()});
                currentMotionSpec.setPropertyValues(CameraStatisticsUtil.IMAGE_WIDTH, propertyValues);
            }
            if (currentMotionSpec.hasPropertyValues(CameraStatisticsUtil.IMAGE_HEIGHT)) {
                PropertyValuesHolder[] propertyValues2 = currentMotionSpec.getPropertyValues(CameraStatisticsUtil.IMAGE_HEIGHT);
                propertyValues2[0].setFloatValues(new float[]{(float) ExtendedFloatingActionButton.this.getHeight(), (float) this.size.getHeight()});
                currentMotionSpec.setPropertyValues(CameraStatisticsUtil.IMAGE_HEIGHT, propertyValues2);
            }
