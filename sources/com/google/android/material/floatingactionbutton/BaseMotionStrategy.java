...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public final MotionSpec getCurrentMotionSpec() {
        ...
        return (MotionSpec) f.a(this.defaultMotionSpec);
    }
    ...
    public AnimatorSet createAnimator(MotionSpec motionSpec2) {
        ...
        if (motionSpec2.hasPropertyValues(CameraStatisticsUtil.IMAGE_WIDTH)) {
            arrayList.add(motionSpec2.getAnimator(CameraStatisticsUtil.IMAGE_WIDTH, this.fab, ExtendedFloatingActionButton.WIDTH));
        }
        if (motionSpec2.hasPropertyValues(CameraStatisticsUtil.IMAGE_HEIGHT)) {
            arrayList.add(motionSpec2.getAnimator(CameraStatisticsUtil.IMAGE_HEIGHT, this.fab, ExtendedFloatingActionButton.HEIGHT));
        }
