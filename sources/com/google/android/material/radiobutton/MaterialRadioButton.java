...
public class MaterialRadioButton extends q {
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.materialThemeColorsTintList == null) {
            ...
            int color4 = MaterialColors.getColor(this, R.attr.colorSurface);
            int[] iArr = new int[ENABLED_CHECKED_STATES.length];
            iArr[0] = MaterialColors.layer(color4, color2, 1.0f);
            iArr[1] = MaterialColors.layer(color4, color3, 0.54f);
            iArr[2] = MaterialColors.layer(color4, color3, 0.38f);
            iArr[3] = MaterialColors.layer(color4, color3, 0.38f);
