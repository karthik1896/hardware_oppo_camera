...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(Context context, AttributeSet attributeSet, int i) {
        ...
        ar obtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, R.styleable.NavigationView, i, DEF_STYLE_RES, new int[0]);
        if (obtainTintedStyledAttributes.g(R.styleable.NavigationView_android_background)) {
            v.a((View) this, obtainTintedStyledAttributes.a(R.styleable.NavigationView_android_background));
        }
        if (getBackground() == null || (getBackground() instanceof ColorDrawable)) {
            ...
            v.a((View) this, (Drawable) materialShapeDrawable);
        }
        if (obtainTintedStyledAttributes.g(R.styleable.NavigationView_elevation)) {
            setElevation((float) obtainTintedStyledAttributes.e(R.styleable.NavigationView_elevation, 0));
        }
        ...
        if (obtainTintedStyledAttributes.g(R.styleable.NavigationView_itemIconTint)) {
            colorStateList = obtainTintedStyledAttributes.e(R.styleable.NavigationView_itemIconTint);
        } else {
        ...
        if (obtainTintedStyledAttributes.g(R.styleable.NavigationView_itemIconSize)) {
            setItemIconSize(obtainTintedStyledAttributes.e(R.styleable.NavigationView_itemIconSize, 0));
        }
        ColorStateList e = obtainTintedStyledAttributes.g(R.styleable.NavigationView_itemTextColor) ? obtainTintedStyledAttributes.e(R.styleable.NavigationView_itemTextColor) : null;
        if (!z && e == null) {
            e = createDefaultColorStateList(16842806);
        }
        Drawable a2 = obtainTintedStyledAttributes.a(R.styleable.NavigationView_itemBackground);
        if (a2 == null && hasShapeAppearance(obtainTintedStyledAttributes)) {
            a2 = createDefaultItemBackground(obtainTintedStyledAttributes);
        }
        ...
        int e2 = obtainTintedStyledAttributes.e(R.styleable.NavigationView_itemIconPadding, 0);
        setItemMaxLines(obtainTintedStyledAttributes.a(R.styleable.NavigationView_itemMaxLines, 1));
        this.menu.setCallback(new h.a() {
        ...
        this.presenter.setItemTextColor(e);
        this.presenter.setItemBackground(a2);
        this.presenter.setItemIconPadding(e2);
    ...
    private boolean hasShapeAppearance(ar arVar) {
        return arVar.g(R.styleable.NavigationView_itemShapeAppearance) || arVar.g(R.styleable.NavigationView_itemShapeAppearanceOverlay);
    }
    ...
    private final Drawable createDefaultItemBackground(ar arVar) {
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(ShapeAppearanceModel.builder(getContext(), arVar.g(R.styleable.NavigationView_itemShapeAppearance, 0), arVar.g(R.styleable.NavigationView_itemShapeAppearanceOverlay, 0)).build());
        materialShapeDrawable.setFillColor(MaterialResources.getColorStateList(getContext(), arVar, R.styleable.NavigationView_itemShapeFillColor));
        return new InsetDrawable(materialShapeDrawable, arVar.e(R.styleable.NavigationView_itemShapeInsetStart, 0), arVar.e(R.styleable.NavigationView_itemShapeInsetTop, 0), arVar.e(R.styleable.NavigationView_itemShapeInsetEnd, 0), arVar.e(R.styleable.NavigationView_itemShapeInsetBottom, 0));
    }
