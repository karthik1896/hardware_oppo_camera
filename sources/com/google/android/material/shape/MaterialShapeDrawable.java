...
public class MaterialShapeDrawable extends Drawable implements b, Shapeable {
    ...
    public static MaterialShapeDrawable createWithElevationOverlay(Context context, float f) {
        int color2 = MaterialColors.getColor(context, R.attr.colorSurface, MaterialShapeDrawable.class.getSimpleName());
    ...
    private boolean updateColorsForState(int[] iArr) {
        ...
        int color3;
        int colorForState2;
        if (this.drawableState.fillColor == null || (color3 = this.fillPaint.getColor()) == (colorForState2 = this.drawableState.fillColor.getColorForState(iArr, color3))) {
            z = false;
        } else {
            this.fillPaint.setColor(colorForState2);
            z = true;
        }
        if (this.drawableState.strokeColor == null || (color2 = this.strokePaint.getColor()) == (colorForState = this.drawableState.strokeColor.getColorForState(iArr, color2))) {
            return z;
        }
