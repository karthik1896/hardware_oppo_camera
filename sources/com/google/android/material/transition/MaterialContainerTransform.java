...
public class MaterialContainerTransform extends Transition {
    ...
    private static void captureValues(TransitionValues transitionValues, View view, int i, ShapeAppearanceModel shapeAppearanceModel) {
        ...
        if (v.A(view2) || view2.getWidth() != 0 || view2.getHeight() != 0) {
    ...
    public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        RectF rectF = (RectF) f.a(transitionValues3.values.get(PROP_BOUNDS));
        RectF rectF2 = (RectF) f.a(transitionValues4.values.get(PROP_BOUNDS));
        ...
        final TransitionDrawable transitionDrawable = new TransitionDrawable(getPathMotion(), view2, rectF, (ShapeAppearanceModel) transitionValues3.values.get(PROP_SHAPE_APPEARANCE), view3, rectF2, (ShapeAppearanceModel) transitionValues4.values.get(PROP_SHAPE_APPEARANCE), this.containerColor, getScrimColorOrDefault(view2.getContext()), isEntering, FadeModeEvaluators.get(this.fadeMode, isEntering), FitModeEvaluators.get(this.fitMode, isEntering, rectF, rectF2), buildThresholdsGroup(isEntering), this.drawDebugEnabled);
    ...
    private int getScrimColorOrDefault(Context context) {
        ...
        return i == -1 ? MaterialColors.getColor(context, R.attr.scrimBackground, a.c(context, R.color.mtrl_scrim_color)) : i;
    }
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f) {
            ...
            float f2 = fArr[0];
            float f3 = fArr[1];
            this.fitModeResult = this.fitModeEvaluator.evaluate(f, ((Float) f.a(Float.valueOf(this.progressThresholds.scale.start))).floatValue(), ((Float) f.a(Float.valueOf(this.progressThresholds.scale.end))).floatValue(), this.startBounds.width(), this.startBounds.height(), this.endBounds.width(), this.endBounds.height());
            ...
            float floatValue = ((Float) f.a(Float.valueOf(this.progressThresholds.scaleMask.start))).floatValue();
            float floatValue2 = ((Float) f.a(Float.valueOf(this.progressThresholds.scaleMask.end))).floatValue();
            ...
            this.fadeModeResult = this.fadeModeEvaluator.evaluate(f, ((Float) f.a(Float.valueOf(this.progressThresholds.fade.start))).floatValue(), ((Float) f.a(Float.valueOf(this.progressThresholds.fade.end))).floatValue());
            invalidateSelf();
        }
