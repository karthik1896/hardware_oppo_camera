...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.a {
    ...
    public BottomAppBar(Context context, AttributeSet attributeSet, int i) {
        ...
        a.a((Drawable) this.materialShapeDrawable, colorStateList);
        v.a((View) this, (Drawable) this.materialShapeDrawable);
        ViewUtils.doOnApplyWindowInsets(this, attributeSet, i, DEF_STYLE_RES, new ViewUtils.OnApplyWindowInsetsListener() {
            public ad onApplyWindowInsets(View view, ad adVar, ViewUtils.RelativePadding relativePadding) {
                ...
                if (BottomAppBar.this.paddingBottomSystemWindowInsets) {
                    int unused = BottomAppBar.this.bottomInset = adVar.d();
                }
                boolean z2 = false;
                if (BottomAppBar.this.paddingLeftSystemWindowInsets) {
                    z = BottomAppBar.this.leftInset != adVar.a();
                    int unused2 = BottomAppBar.this.leftInset = adVar.a();
                } else {
                    z = false;
                }
                if (BottomAppBar.this.paddingRightSystemWindowInsets) {
                    if (BottomAppBar.this.rightInset != adVar.c()) {
                        z2 = true;
                    }
                    int unused3 = BottomAppBar.this.rightInset = adVar.c();
                }
                if (z || z2) {
    ...
    private void maybeAnimateModeChange(int i) {
        if (this.fabAlignmentMode != i && v.A(this)) {
    ...
    public int getActionMenuViewTranslationX(ActionMenuView actionMenuView, int i, boolean z) {
        ...
        for (int i2 = 0; i2 < getChildCount(); i2++) {
            ...
            if ((childAt.getLayoutParams() instanceof Toolbar.b) && (((Toolbar.b) childAt.getLayoutParams()).f172a & 8388615) == 8388611) {
                if (isLayoutRtl) {
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, BottomAppBar bottomAppBar, int i) {
            ...
            if (access$2800 != null && !v.A(access$2800)) {
                CoordinatorLayout.e eVar = (CoordinatorLayout.e) access$2800.getLayoutParams();
                eVar.d = 49;
