...
final class IndicatorViewController {
    ...
    private boolean shouldAnimateCaptionView(TextView textView, CharSequence charSequence) {
        return v.A(this.textInputView) && this.textInputView.isEnabled() && (this.captionToShow != this.captionDisplayed || textView == null || !TextUtils.equals(textView.getText(), charSequence));
    }
    ...
    public void adjustIndicatorPadding() {
        if (canAdjustIndicatorPadding()) {
            v.b(this.indicatorArea, v.j(this.textInputView.getEditText()), 0, v.k(this.textInputView.getEditText()), 0);
        }
    }
    ...
    public void setHelperTextEnabled(boolean z) {
        if (this.helperTextEnabled != z) {
            ...
            if (z) {
                ...
                v.d((View) this.helperTextView, 1);
