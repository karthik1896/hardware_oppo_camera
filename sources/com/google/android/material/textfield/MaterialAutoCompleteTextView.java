...
public class MaterialAutoCompleteTextView extends d {
    ...
    public final ae modalListPopup;
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.modalListPopup = new ae(context2);
        this.modalListPopup.a(true);
        this.modalListPopup.b((View) this);
        this.modalListPopup.i(2);
        this.modalListPopup.a(getAdapter());
        this.modalListPopup.a((AdapterView.OnItemClickListener) new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                MaterialAutoCompleteTextView.this.updateText(i < 0 ? MaterialAutoCompleteTextView.this.modalListPopup.n() : MaterialAutoCompleteTextView.this.getAdapter().getItem(i));
                AdapterView.OnItemClickListener onItemClickListener = MaterialAutoCompleteTextView.this.getOnItemClickListener();
                if (onItemClickListener != null) {
                    if (view == null || i < 0) {
                        view = MaterialAutoCompleteTextView.this.modalListPopup.q();
                        i = MaterialAutoCompleteTextView.this.modalListPopup.o();
                        j = MaterialAutoCompleteTextView.this.modalListPopup.p();
                    }
                    onItemClickListener.onItemClick(MaterialAutoCompleteTextView.this.modalListPopup.b_(), view, i, j);
                }
                MaterialAutoCompleteTextView.this.modalListPopup.b();
            }
        });
    ...
    private int measureContentWidth() {
        ...
        int min = Math.min(adapter.getCount(), Math.max(0, this.modalListPopup.o()) + 15);
        int i2 = 0;
        View view = null;
