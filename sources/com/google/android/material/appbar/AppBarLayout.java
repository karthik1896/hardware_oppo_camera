...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.a {
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        v.a((View) this, obtainStyledAttributes.getDrawable(R.styleable.AppBarLayout_android_background));
        ...
        v.a((View) this, (q) new q() {
            public ad onApplyWindowInsets(View view, ad adVar) {
                return AppBarLayout.this.onWindowInsetChanged(adVar);
            }
        });
    }
    ...
    public void setStatusBarForeground(Drawable drawable) {
        ...
        if (drawable2 != drawable) {
            ...
            if (drawable4 != null) {
                ...
                a.b(this.statusBarForeground, v.g(this));
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (mode != 1073741824 && v.t(this) && shouldOffsetFirstChild()) {
            int measuredHeight = getMeasuredHeight();
            if (mode == Integer.MIN_VALUE) {
                measuredHeight = androidx.core.b.a.a(getMeasuredHeight() + getTopInset(), 0, View.MeasureSpec.getSize(i2));
            } else if (mode == 0) {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (v.t(this) && shouldOffsetFirstChild()) {
        ...
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            if ((i4 & 5) == 5) {
                ...
                if ((i4 & 8) != 0) {
                    ...
                    m = measuredHeight - v.m(childAt);
                } else {
                    i = i5 + measuredHeight;
                    if (childCount == 0 && v.t(childAt)) {
    ...
    private boolean shouldOffsetFirstChild() {
        ...
        if (childAt.getVisibility() == 8 || v.t(childAt)) {
            return false;
        }
        return true;
    }
    ...
    /* access modifiers changed from: package-private */
    public ad onWindowInsetChanged(ad adVar) {
        ad adVar2 = v.t(this) ? adVar : null;
        if (!c.a(this.lastInsets, adVar2)) {
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, T t) {
            ...
            if (childIndexOnOffset >= 0) {
                ...
                if ((scrollFlags & 17) == 17) {
                    ...
                    animateOffsetTo(coordinatorLayout, t, androidx.core.b.a.a(i, -t.getTotalScrollRange(), 0), 0.0f);
                }
            }
        }
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, T t, int i) {
            ...
            setTopAndBottomOffset(androidx.core.b.a.a(getTopAndBottomOffset(), -t.getTotalScrollRange(), 0));
        ...
        private void updateAccessibilityActions(CoordinatorLayout coordinatorLayout, T t) {
            v.c((View) coordinatorLayout, d.a.m.a());
            v.c((View) coordinatorLayout, d.a.n.a());
            View findFirstScrollingChild = findFirstScrollingChild(coordinatorLayout);
            if (findFirstScrollingChild != null && t.getTotalScrollRange() != 0 && (((CoordinatorLayout.e) findFirstScrollingChild.getLayoutParams()).b() instanceof ScrollingViewBehavior)) {
        ...
        private void addAccessibilityScrollActions(CoordinatorLayout coordinatorLayout, T t, View view) {
            if (getTopBottomOffsetForScrollingSibling() != (-t.getTotalScrollRange()) && view.canScrollVertically(1)) {
                addActionToExpand(coordinatorLayout, t, d.a.m, false);
            }
            ...
            if (view.canScrollVertically(-1)) {
                ...
                if (i != 0) {
                    ...
                    v.a(coordinatorLayout, d.a.n, (CharSequence) null, new g() {
            ...
            addActionToExpand(coordinatorLayout, t, d.a.n, true);
        }

        private void addActionToExpand(CoordinatorLayout coordinatorLayout, final T t, d.a aVar, final boolean z) {
            v.a(coordinatorLayout, aVar, (CharSequence) null, new g() {
                public boolean perform(View view, g.a aVar) {
                    t.setExpanded(z);
                    return true;
                }
        ...
        private boolean shouldJumpElevationState(CoordinatorLayout coordinatorLayout, T t) {
            ...
            while (i < size) {
                ...
                if (!(b2 instanceof ScrollingViewBehavior)) {
                    i++;
                } else if (((ScrollingViewBehavior) b2).getOverlayTop() != 0) {
                    return true;
                } else {
                    return false;
                }
        ...
        public Parcelable onSaveInstanceState(CoordinatorLayout coordinatorLayout, T t) {
            ...
            while (i < childCount) {
                ...
                if (childAt.getTop() + topAndBottomOffset > 0 || bottom < 0) {
                    ...
                    if (bottom == v.m(childAt) + t.getTopInset()) {
                        z = true;
                    }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        private void offsetChildAsNeeded(View view, View view2) {
            ...
            if (b2 instanceof BaseBehavior) {
                v.e(view, (((view2.getBottom() - view.getTop()) + ((BaseBehavior) b2).offsetDelta) + getVerticalLayoutGap()) - getOverlapPixelsForOffset(view2));
            }
        }
