...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        v.a((View) this, (q) new q() {
            public ad onApplyWindowInsets(View view, ad adVar) {
                return CollapsingToolbarLayout.this.onWindowInsetChanged(adVar);
            }
        });
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (adVar != null) {
            ...
            for (int i5 = 0; i5 < childCount; i5++) {
                ...
                if (!v.t(childAt) && childAt.getTop() < b2) {
                    v.e(childAt, b2);
                }
            }
        }
        ...
        if (this.collapsingTitleEnabled && (view = this.dummyView) != null) {
            boolean z2 = true;
            this.drawCollapsingTitle = v.D(view) && this.dummyView.getVisibility() == 0;
    ...
    public void setScrimsShown(boolean z) {
        setScrimsShown(z, v.A(this) && !isInEditMode());
    }
    ...
    public void setStatusBarScrim(Drawable drawable) {
        ...
        if (drawable2 != drawable) {
            ...
            if (drawable4 != null) {
                ...
                androidx.core.graphics.drawable.a.b(this.statusBarScrim, v.g(this));
    ...
    public int getScrimVisibleHeightTrigger() {
        ...
        int m = v.m(this);
        if (m > 0) {
            return Math.min((m * 2) + b2, getHeight());
        }
        return getHeight() / 3;
    }
    ...
    private class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int i) {
            ...
            int b2 = collapsingToolbarLayout.lastInsets != null ? CollapsingToolbarLayout.this.lastInsets.b() : 0;
            ...
            if (CollapsingToolbarLayout.this.statusBarScrim != null && b2 > 0) {
                v.e(CollapsingToolbarLayout.this);
            }
            CollapsingToolbarLayout.this.collapsingTextHelper.setExpansionFraction(((float) Math.abs(i)) / ((float) ((CollapsingToolbarLayout.this.getHeight() - v.m(CollapsingToolbarLayout.this)) - b2)));
        }
    }
}
