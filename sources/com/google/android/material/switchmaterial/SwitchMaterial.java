...
public class SwitchMaterial extends SwitchCompat {
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            ...
            int color3 = MaterialColors.getColor(this, R.attr.colorControlActivated);
            ...
            int compositeOverlayIfNeeded = this.elevationOverlayProvider.compositeOverlayIfNeeded(color2, dimension);
            int[] iArr = new int[ENABLED_CHECKED_STATES.length];
            iArr[0] = MaterialColors.layer(color2, color3, 1.0f);
    ...
    private ColorStateList getMaterialThemeColorsTrackTintList() {
        if (this.materialThemeColorsTrackTintList == null) {
            ...
            iArr[0] = MaterialColors.layer(color2, color3, 0.54f);
            iArr[1] = MaterialColors.layer(color2, color4, 0.32f);
            iArr[2] = MaterialColors.layer(color2, color3, 0.12f);
            iArr[3] = MaterialColors.layer(color2, color4, 0.12f);
