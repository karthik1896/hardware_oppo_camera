...
public class ShadowDrawableWrapper extends c {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        super(drawable);
        this.shadowStartColor = a.c(context, R.color.design_fab_shadow_start_color);
        this.shadowMiddleColor = a.c(context, R.color.design_fab_shadow_mid_color);
        this.shadowEndColor = a.c(context, R.color.design_fab_shadow_end_color);
