...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        if (getBackground() instanceof ColorDrawable) {
            ...
            materialShapeDrawable.setElevation(v.o(this));
    ...
    private void setupWithViewPager(ViewPager viewPager2, boolean z, boolean z2) {
        ...
        if (viewPager3 != null) {
            ...
            if (tabLayoutOnPageChangeListener != null) {
                viewPager3.b((ViewPager.f) tabLayoutOnPageChangeListener);
            }
            AdapterChangeListener adapterChangeListener2 = this.adapterChangeListener;
            if (adapterChangeListener2 != null) {
                this.viewPager.b((ViewPager.e) adapterChangeListener2);
            }
        }
        ...
        if (viewPager2 != null) {
            ...
            viewPager2.a((ViewPager.f) this.pageChangeListener);
            ...
            viewPager2.a((ViewPager.e) this.adapterChangeListener);
            setScrollPosition(viewPager2.getCurrentItem(), 0.0f, true);
        } else {
            this.viewPager = null;
            setPagerAdapter((a) null, false);
        }
    ...
    public void populateFromPagerAdapter() {
        ...
        if (aVar != null) {
            int a2 = aVar.a();
            for (int i = 0; i < a2; i++) {
                addTab(newTab().setText(this.pagerAdapter.a(i)), false);
            }
            ViewPager viewPager2 = this.viewPager;
            if (viewPager2 != null && a2 > 0 && (currentItem = viewPager2.getCurrentItem()) != getSelectedTabPosition() && currentItem < getTabCount()) {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        d.a(accessibilityNodeInfo).a((Object) d.b.a(1, getTabCount(), false, 1));
    }
    ...
    private void animateToTab(int i) {
        if (i != -1) {
            if (getWindowToken() == null || !v.A(this) || this.slidingTabIndicator.childrenNeedLayout()) {
    ...
    private int calculateScrollXForTab(int i, float f) {
        ...
        return v.g(this) == 0 ? left + i5 : left - i5;
    }
    ...
    private void applyModeAndGravity() {
        ...
        v.b(this.slidingTabIndicator, i, 0, 0, 0);
        int i3 = this.mode;
        if (i3 == 0) {
    ...
    public final class TabView extends LinearLayout {
        ...
        public TabView(Context context) {
            ...
            v.b(this, TabLayout.this.tabPaddingStart, TabLayout.this.tabPaddingTop, TabLayout.this.tabPaddingEnd, TabLayout.this.tabPaddingBottom);
            setGravity(17);
        ...
        public void updateBackgroundDrawable(android.content.Context r7) {
            ...
            L_0x006b:
                ...
                r7 = r1
            L_0x0080:
                androidx.core.g.v.a((android.view.View) r6, (android.graphics.drawable.Drawable) r7)
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            a2.b((Object) d.c.a(0, 1, this.tab.getPosition(), 1, false, isSelected()));
            if (isSelected()) {
                a2.h(false);
                a2.b(d.a.e);
            }
            a2.i((CharSequence) "Tab");
        }
        ...
        public final void update() {
            ...
            if (this.customView == null) {
                ...
                if (!(tab2 == null || tab2.getIcon() == null)) {
                    drawable = androidx.core.graphics.drawable.a.g(tab2.getIcon()).mutate();
                }
                if (drawable != null) {
                ...
                if (this.textView == null) {
                    ...
                    this.defaultMaxLines = i.a(this.textView);
                }
        ...
        private void updateTextAndIcon(TextView textView2, ImageView imageView) {
            Tab tab2 = this.tab;
            Drawable mutate = (tab2 == null || tab2.getIcon() == null) ? null : androidx.core.graphics.drawable.a.g(this.tab.getIcon()).mutate();
            Tab tab3 = this.tab;
            ...
            if (imageView != null) {
                ...
                if (TabLayout.this.inlineLabel) {
                    if (dpToPx != f.b(marginLayoutParams)) {
                        f.b(marginLayoutParams, dpToPx);
    ...
    class SlidingTabIndicator extends LinearLayout {
        ...
        public void draw(Canvas canvas) {
            ...
            if (i4 >= 0 && this.indicatorRight > i4) {
                Drawable mutate = androidx.core.graphics.drawable.a.g(TabLayout.this.tabSelectedIndicator != null ? TabLayout.this.tabSelectedIndicator : this.defaultSelectionIndicator).mutate();
                ...
                if (this.selectedIndicatorPaint != null) {
                    if (Build.VERSION.SDK_INT == 21) {
                        ...
                        androidx.core.graphics.drawable.a.a(mutate, this.selectedIndicatorPaint.getColor());
                    }
                }
                mutate.draw(canvas);
            }
    ...
    private class AdapterChangeListener implements ViewPager.e {
