...
public class BottomNavigationView extends FrameLayout {
    ...
    public BottomNavigationView(Context context, AttributeSet attributeSet, int i) {
        ...
        ar obtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, R.styleable.BottomNavigationView, i, R.style.Widget_Design_BottomNavigationView, R.styleable.BottomNavigationView_itemTextAppearanceInactive, R.styleable.BottomNavigationView_itemTextAppearanceActive);
        ...
        if (getBackground() == null || (getBackground() instanceof ColorDrawable)) {
            v.a((View) this, (Drawable) createMaterialShapeDrawableBackground(context2));
        }
        if (obtainTintedStyledAttributes.g(R.styleable.BottomNavigationView_elevation)) {
            v.a((View) this, (float) obtainTintedStyledAttributes.e(R.styleable.BottomNavigationView_elevation, 0));
        }
    ...
    private void applyWindowInsets() {
        ViewUtils.doOnApplyWindowInsets(this, new ViewUtils.OnApplyWindowInsetsListener() {
            public ad onApplyWindowInsets(View view, ad adVar, ViewUtils.RelativePadding relativePadding) {
    ...
    public void setItemRippleColor(ColorStateList colorStateList) {
        if (this.itemRippleColor != colorStateList) {
            ...
            Drawable g = a.g(gradientDrawable);
            a.a(g, convertToRippleDrawableColor);
