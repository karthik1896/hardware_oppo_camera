...
public class BottomNavigationItemView extends FrameLayout implements o.a {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        v.b((View) this.smallLabel, 2);
        v.b((View) this.largeLabel, 2);
        setFocusable(true);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        a2.b((Object) d.c.a(0, 1, getItemPosition(), 1, false, isSelected()));
        if (isSelected()) {
            a2.h(false);
            a2.b(d.a.e);
        }
        ...
        if (drawable != this.originalIconDrawable) {
            ...
            if (drawable != null) {
                ...
                if (colorStateList != null) {
                    a.a(this.wrappedIconDrawable, colorStateList);
                }
            }
