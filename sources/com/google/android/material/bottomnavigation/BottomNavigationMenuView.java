...
public class BottomNavigationMenuView extends ViewGroup implements o {
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attributeSet) {
        ...
        this.set.setInterpolator((TimeInterpolator) new androidx.d.a.a.b());
        this.set.a((m) new TextScale());
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        d.a(accessibilityNodeInfo).a((Object) d.b.a(1, this.menu.getVisibleItems().size(), false, 1));
    }
    ...
    public void buildMenuView() {
        ...
        for (int i = 0; i < this.menu.size(); i++) {
            ...
            newItem.initialize((j) this.menu.getItem(i), 0);
    ...
    public void updateMenuView() {
        ...
        if (hVar != null && this.buttons != null) {
            ...
            if (i != this.selectedItemId) {
                androidx.transition.o.a(this, this.set);
            }
            boolean isShifting = isShifting(this.labelVisibilityMode, this.menu.getVisibleItems().size());
            for (int i3 = 0; i3 < size; i3++) {
                ...
                this.buttons[i3].initialize((j) this.menu.getItem(i3), 0);
                this.presenter.setUpdateSuspended(false);
            }
        }
    }
