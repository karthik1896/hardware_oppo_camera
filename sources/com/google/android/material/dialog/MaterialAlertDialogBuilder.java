...
public class MaterialAlertDialogBuilder extends b.a {
    ...
    private static Context createMaterialAlertDialogThemedContext(Context context) {
        ...
        return new d(wrap, materialAlertDialogThemeOverlay);
    }
    ...
    public MaterialAlertDialogBuilder(Context context, int i) {
        ...
        int color2 = MaterialColors.getColor(context2, R.attr.colorSurface, getClass().getCanonicalName());
    ...
    public b create() {
        ...
        if (drawable instanceof MaterialShapeDrawable) {
            ((MaterialShapeDrawable) drawable).setElevation(v.o(decorView));
        }
