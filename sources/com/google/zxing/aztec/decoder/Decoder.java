...
public final class Decoder {
    private static final String[] DIGIT_TABLE = {"CTRL_PS", " ", "0", "1", "2", "3", FocusAimMsgData.KEY_HYPER_LAPSE_FOCUS_TYPE, CameraStatisticsUtil.FUNC_KEY_SETTING, FocusAimMsgData.KEY_TOUCH_TAKE_PICTURE, "7", FocusAimMsgData.KEY_MULTI_VIDEO_DRAG_SCREEN_FOCUS_TYPE, FocusAimMsgData.KEY_MULTI_VIDEO_SWITCH_SCREEN_FOCUS_TYPE, ",", ".", "CTRL_UL", "CTRL_US"};
    ...
    private static final String[] MIXED_TABLE = {"CTRL_PS", " ", "\u0001", "\u0002", "\u0003", "\u0004", "\u0005", "\u0006", "\u0007", "\b", "\t", "\n", "\u000b", "\f", "\r", "\u001b", "\u001c", "\u001d", "\u001e", "\u001f", "@", "\\", "^", "_", "`", DcsMsgData.DIVIDER, "~", "", "CTRL_LL", "CTRL_UL", "CTRL_PL", "CTRL_BS"};
    private static final String[] PUNCT_TABLE = {"", "\r", "\r\n", ". ", ", ", ": ", "!", "\"", "#", "$", "%", "&", "'", "(", ")", "*", "+", ",", "-", ".", "/", ":", ";", "<", "=", ">", "?", "[", "]", "{", "}", "CTRL_UL"};
    private static final String[] UPPER_TABLE = {"CTRL_PS", " ", OppoExifInterface.GpsStatus.IN_PROGRESS, "B", "C", "D", OppoExifInterface.GpsLongitudeRef.EAST, "F", "G", "H", "I", "J", OppoExifInterface.GpsSpeedRef.KILOMETERS, "L", "M", "N", "O", "P", "Q", "R", OppoExifInterface.GpsLatitudeRef.SOUTH, OppoExifInterface.GpsTrackRef.TRUE_DIRECTION, "U", OppoExifInterface.GpsStatus.INTEROPERABILITY, OppoExifInterface.GpsLongitudeRef.WEST, "X", "Y", "Z", "CTRL_LL", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
