...
public class o {
    ...
    public Matrix d() {
        ...
        if (aVar != null) {
            ...
            if (!(g2.x == 0.0f && g2.y == 0.0f)) {
                this.f2325a.preTranslate(g2.x, g2.y);
            }
        }
        ...
        if (this.k != null) {
            ...
            this.c.preConcat(this.f2326b);
            this.d.preConcat(this.c);
            this.f2325a.preConcat(this.d);
        }
        a<d, d> aVar3 = this.h;
        if (aVar3 != null) {
            d g3 = aVar3.g();
            if (!(g3.a() == 1.0f && g3.b() == 1.0f)) {
                this.f2325a.preScale(g3.a(), g3.b());
            }
        }
        a<PointF, PointF> aVar4 = this.f;
        if (aVar4 != null) {
            ...
            if (!(g4.x == 0.0f && g4.y == 0.0f)) {
                this.f2325a.preTranslate(-g4.x, -g4.y);
            }
        }
        return this.f2325a;
    }
    ...
    public Matrix b(float f2) {
        ...
        this.f2325a.reset();
        if (g2 != null) {
            this.f2325a.preTranslate(g2.x * f2, g2.y * f2);
        }
        if (g3 != null) {
            double d2 = (double) f2;
            this.f2325a.preScale((float) Math.pow((double) g3.a(), d2), (float) Math.pow((double) g3.b(), d2));
        }
    ...
    public <T> boolean a(T t, b<T> bVar) {
        ...
        a<?, Float> aVar;
        a<?, Float> aVar2;
        if (t == com.coloros.anim.d.e) {
            a<PointF, PointF> aVar3 = this.f;
            if (aVar3 == null) {
                this.f = new p(bVar, new PointF());
                return true;
            }
            aVar3.a((b<PointF>) bVar);
            return true;
        } else if (t == com.coloros.anim.d.f) {
            a<?, PointF> aVar4 = this.g;
            if (aVar4 == null) {
                this.g = new p(bVar, new PointF());
                return true;
            }
            aVar4.a((b<PointF>) bVar);
            return true;
        } else if (t == com.coloros.anim.d.i) {
            a<d, d> aVar5 = this.h;
            if (aVar5 == null) {
                this.h = new p(bVar, new d());
                return true;
            }
            aVar5.a((b<d>) bVar);
            return true;
        } else if (t == com.coloros.anim.d.j) {
            a<Float, Float> aVar6 = this.i;
            if (aVar6 == null) {
                this.i = new p(bVar, Float.valueOf(0.0f));
                return true;
            }
            aVar6.a((b<Float>) bVar);
            return true;
        } else if (t == com.coloros.anim.d.c) {
            a<Integer, Integer> aVar7 = this.j;
            if (aVar7 == null) {
                this.j = new p(bVar, 100);
                return true;
            }
            aVar7.a((b<Integer>) bVar);
            return true;
        } else if (t != com.coloros.anim.d.w || (aVar2 = this.m) == null) {
            if (t != com.coloros.anim.d.x || (aVar = this.n) == null) {
                if (t == com.coloros.anim.d.k && (cVar2 = this.k) != null) {
                    if (cVar2 == null) {
                        this.k = new c(Collections.singletonList(new c(Float.valueOf(0.0f))));
                    }
                    this.k.a(bVar);
                    return true;
                } else if (t != com.coloros.anim.d.l || (cVar = this.l) == null) {
                    return false;
                } else {
                    if (cVar == null) {
                        this.l = new c(Collections.singletonList(new c(Float.valueOf(0.0f))));
                    }
                    this.l.a(bVar);
                    return true;
                }
            ...
            this.m = new p(bVar, 100);
            return true;
        } else {
            aVar2.a((b<Float>) bVar);
            return true;
        }
    }
}
