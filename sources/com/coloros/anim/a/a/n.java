...
public class n implements k, m, a.C0061a {
    ...
    public n(b bVar, com.coloros.anim.c.c.a aVar, i iVar) {
        this.c = bVar;
        this.f2310b = iVar.a();
        this.d = iVar.b();
        this.e = iVar.j();
    ...
    public Path e() {
        ...
        int i2 = AnonymousClass1.f2311a[this.d.ordinal()];
        if (i2 == 1) {
            d();
        } else if (i2 == 2) {
            f();
        ...
        this.f2309a.close();
        this.m.a(this.f2309a);
        this.n = true;
        return this.f2309a;
    }

    /* renamed from: com.coloros.anim.a.a.n$1  reason: invalid class name */
    /* compiled from: PolystarContent */
    static /* synthetic */ class AnonymousClass1 {

        /* renamed from: a  reason: collision with root package name */
        static final /* synthetic */ int[] f2311a = new int[i.a.values().length];
        ...
        static {
            /*
                com.coloros.anim.c.b.i$a[] r0 = com.coloros.anim.c.b.i.a.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f2311a = r0
                int[] r0 = f2311a     // Catch:{ NoSuchFieldError -> 0x0014 }
                com.coloros.anim.c.b.i$a r1 = com.coloros.anim.c.b.i.a.STAR     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = f2311a     // Catch:{ NoSuchFieldError -> 0x001f }
                com.coloros.anim.c.b.i$a r1 = com.coloros.anim.c.b.i.a.POLYGON     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.coloros.anim.a.a.n.AnonymousClass1.<clinit>():void");
        }
    }
        ...
        while (true) {
            ...
            if (d8 < ceil) {
                ...
                if (floatValue4 == 0.0f && floatValue5 == 0.0f) {
                    ...
                    this.f2309a.cubicTo(f20 - f24, f3 - f25, cos2 + f27, f13 + f28, cos2, f13);
                }
                d7 += (double) f19;
                z = !z;
                i4++;
    ...
    private void f() {
        ...
        while (((double) i3) < ceil) {
            ...
            if (floatValue != 0.0f) {
                ...
                this.f2309a.cubicTo(cos - (cos3 * f2), sin - (((float) Math.sin(atan2)) * f2), cos2 + (((float) Math.cos(atan22)) * f2), sin2 + (f2 * ((float) Math.sin(atan22))), cos2, sin2);
            } else {
                d3 = d8;
                d4 = d6;
                d2 = d7;
    ...
    public <T> void a(T t, com.coloros.anim.g.b<T> bVar) {
        ...
        if (t == d.q) {
            ...
            this.g.a(bVar);
        } else if (t == d.s && (aVar2 = this.i) != null) {
            aVar2.a((com.coloros.anim.g.b<Float>) bVar);
        } else if (t == d.t) {
            this.j.a(bVar);
        } else if (t == d.u && (aVar = this.k) != null) {
