...
class r {
    ...
    private static final Interpolator f2442a = new LinearInterpolator();

    /* renamed from: b  reason: collision with root package name */
    private static SparseArrayCompat<WeakReference<Interpolator>> f2443b;
    ...
    private static void a(int i, WeakReference<Interpolator> weakReference) {
        synchronized (r.class) {
            f2443b.put(i, weakReference);
        }
    }

    static <T> c<T> a(JsonReader jsonReader, a aVar, float f, aj<T> ajVar, boolean z) throws IOException {
        if (z) {
            return a(aVar, jsonReader, f, ajVar);
        }
        return a(jsonReader, f, ajVar);
    }

    private static <T> c<T> a(JsonReader jsonReader, float f, aj<T> ajVar) throws IOException {
        return new c<>(ajVar.b(jsonReader, f));
    }
    ...
    private static <T> com.coloros.anim.g.c<T> a(com.coloros.anim.a r17, android.util.JsonReader r18, float r19, com.coloros.anim.e.aj<T> r20) throws java.io.IOException {
        /*
            r0 = r18
            r1 = r19
            r2 = r20
        ...
        L_0x0097:
            ...
            goto L_0x0012
        L_0x009c:
            android.graphics.PointF r3 = com.coloros.anim.e.q.b(r18, r19)
            r15 = r3
            goto L_0x0012
        L_0x00a3:
            android.graphics.PointF r3 = com.coloros.anim.e.q.b(r18, r19)
        ...
        L_0x00d9:
            ...
            android.view.animation.Interpolator r0 = f2442a
            r11 = r0
            r10 = r9
            goto L_0x0151
        L_0x00e4:
            ...
            float r0 = r6.x
            float r2 = -r1
            float r0 = com.coloros.anim.f.f.b(r0, r2, r1)
            r6.x = r0
            float r0 = r6.y
            r3 = 1120403456(0x42c80000, float:100.0)
            r4 = -1027080192(0xffffffffc2c80000, float:-100.0)
            float r0 = com.coloros.anim.f.f.b(r0, r4, r3)
            r6.y = r0
            float r0 = r7.x
            float r0 = com.coloros.anim.f.f.b(r0, r2, r1)
            r7.x = r0
            ...
            float r3 = r7.x
            float r4 = r7.y
            int r0 = com.coloros.anim.f.g.a((float) r0, (float) r2, (float) r3, (float) r4)
        ...
        L_0x014d:
            ...
            r10 = r8
        L_0x0151:
            com.coloros.anim.g.c r0 = new com.coloros.anim.g.c
            r13 = 0
            r7 = r0
            r8 = r17
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.coloros.anim.e.r.a(com.coloros.anim.a, android.util.JsonReader, float, com.coloros.anim.e.aj):com.coloros.anim.g.c");
    }
}
