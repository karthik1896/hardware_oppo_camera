...
public class w extends b {
    public static LruCache<String, w> q = new LruCache<>(5);
    public int r;
    public int s;
    public int t;
    public Mesh u;
    ...
    public w(Resources resources, Context context) {
        super(resources, t.a("compute_b"), context);
    }

    public static w a(Resources resources, Context context) {
        w wVar = q.get(Thread.currentThread().getName());
        if (wVar == null) {
            wVar = new w(resources, context);
            wVar.a();
            q.put(Thread.currentThread().getName(), wVar);
        }
        wVar.a(context);
        return wVar;
    }
    ...
    public void d() {
        ...
        int glGetUniformLocation2 = GLES20.glGetUniformLocation(this.f3b, "mean_p");
        GLES20.glActiveTexture(33985);
        GLES20.glBindTexture(3553, this.s);
        GLES20.glUniform1i(glGetUniformLocation2, 1);
        int glGetUniformLocation3 = GLES20.glGetUniformLocation(this.f3b, "a");
