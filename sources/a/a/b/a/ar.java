...
public class ar extends b {
    public static LruCache<String, ar> q = new LruCache<>(5);
    public int r;
    public int s;
    public int t;
    public float[] u;
    ...
    public ar(Resources resources, Context context) {
        super(resources, t.a("propagate"), context);
        this.o = t.a("patchmatch_vertex");
    }

    public static ar a(Resources resources, Context context) {
        ar arVar = q.get(Thread.currentThread().getName());
        if (arVar == null) {
            arVar = new ar(resources, context);
            arVar.a();
            q.put(Thread.currentThread().getName(), arVar);
        }
        arVar.a(context);
        return arVar;
    }
    ...
    public void i() {
        ...
        int glGetUniformLocation6 = GLES20.glGetUniformLocation(this.f3b, "field_size");
        float[] fArr3 = this.w;
        GLES20.glUniform2f(glGetUniformLocation6, fArr3[0], fArr3[1]);
        int glGetUniformLocation7 = GLES20.glGetUniformLocation(this.f3b, "full_size");
        float[] fArr4 = this.x;
        GLES20.glUniform2f(glGetUniformLocation7, fArr4[0], fArr4[1]);
        GLES20.glUniform1f(GLES20.glGetUniformLocation(this.f3b, "jump"), this.y);
        GLES20.glUniformMatrix4fv(GLES20.glGetUniformLocation(this.f3b, "region"), 1, false, this.z, 0);
    }
}
