...
public class f extends b {
    public static LruCache<String, f> q = new LruCache<>(5);
    public int r;
    public int s;
    public int t;
    public Mesh u;
    ...
    public f(Resources resources, Context context) {
        super(resources, t.a("combine"), context);
    }

    public static f a(Resources resources, Context context) {
        f fVar = q.get(Thread.currentThread().getName());
        if (fVar == null) {
            fVar = new f(resources, context);
            fVar.a();
            q.put(Thread.currentThread().getName(), fVar);
        }
        fVar.a(context);
        return fVar;
    }
    ...
    public void d() {
        int glGetUniformLocation = GLES20.glGetUniformLocation(this.f3b, "a");
        GLES20.glActiveTexture(33984);
        GLES20.glBindTexture(3553, this.r);
        GLES20.glUniform1i(glGetUniformLocation, 0);
        int glGetUniformLocation2 = GLES20.glGetUniformLocation(this.f3b, "b");
        GLES20.glActiveTexture(33985);
        GLES20.glBindTexture(3553, this.s);
        GLES20.glUniform1i(glGetUniformLocation2, 1);
        int glGetUniformLocation3 = GLES20.glGetUniformLocation(this.f3b, "I");
