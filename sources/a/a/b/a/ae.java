...
public class ae extends b {
    public static LruCache<String, ae> q = new LruCache<>(5);
    public int r;
    public int s;
    public int t;
    public float[] u;
    ...
    public ae(Resources resources, Context context) {
        super(resources, t.a("maximization"), context);
        this.o = t.a("patchmatch_vertex");
    }

    public static ae a(Resources resources, Context context) {
        ae aeVar = q.get(Thread.currentThread().getName());
        if (aeVar == null) {
            aeVar = new ae(resources, context);
            aeVar.a();
            q.put(Thread.currentThread().getName(), aeVar);
        }
        aeVar.a(context);
        return aeVar;
    }
    ...
    public void i() {
        ...
        int glGetUniformLocation4 = GLES20.glGetUniformLocation(this.f3b, "target_size");
        float[] fArr = this.u;
        GLES20.glUniform2f(glGetUniformLocation4, fArr[0], fArr[1]);
        int glGetUniformLocation5 = GLES20.glGetUniformLocation(this.f3b, "full_size");
        float[] fArr2 = this.v;
        GLES20.glUniform2f(glGetUniformLocation5, fArr2[0], fArr2[1]);
        GLES20.glUniformMatrix4fv(GLES20.glGetUniformLocation(this.f3b, "region"), 1, false, this.w, 0);
    }
}
