...
public class bn extends b {
    public bn(Resources resources, Context context) {
        super(resources, t.a("dehaze"), context);
    ...
    public void i() {
        super.i();
        int glGetUniformLocation = GLES20.glGetUniformLocation(this.f3b, "dehazeMap");
        GLES20.glActiveTexture(33985);
        GLES20.glBindTexture(3553, this.f2a.dehazeTexture.f11a);
        GLES20.glUniform1i(glGetUniformLocation, 1);
        GLES20.glUniform3fv(GLES20.glGetUniformLocation(this.f3b, "average"), 1, this.f2a.thresholdAverage, 0);
