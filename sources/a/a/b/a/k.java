...
public class k extends b {
    public static LruCache<String, k> q = new LruCache<>(5);
    public int r;
    public int s;
    public int t;
    public float[] u;
    ...
    public k(Resources resources, Context context) {
        super(resources, t.a("initialize_from_field"), context);
        this.o = t.a("patchmatch_vertex");
    }

    public static k a(Resources resources, Context context) {
        k kVar = q.get(Thread.currentThread().getName());
        if (kVar == null) {
            kVar = new k(resources, context);
            kVar.a();
            q.put(Thread.currentThread().getName(), kVar);
        }
        kVar.a(context);
        return kVar;
    }
    ...
    public void i() {
        ...
        GLES20.glUniformMatrix4fv(GLES20.glGetUniformLocation(this.f3b, "region"), 1, false, this.x, 0);
    }
}
