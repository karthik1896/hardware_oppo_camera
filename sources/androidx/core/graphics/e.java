...
public class e {
    ...
    public static boolean a(b[] bVarArr, b[] bVarArr2) {
        ...
        for (int i = 0; i < bVarArr.length; i++) {
            if (bVarArr[i].f740a != bVarArr2[i].f740a || bVarArr[i].f741b.length != bVarArr2[i].f741b.length) {
                return false;
            }
        }
        return true;
    ...
    public static void b(b[] bVarArr, b[] bVarArr2) {
        for (int i = 0; i < bVarArr2.length; i++) {
            bVarArr[i].f740a = bVarArr2[i].f740a;
            for (int i2 = 0; i2 < bVarArr2[i].f741b.length; i2++) {
                bVarArr[i].f741b[i2] = bVarArr2[i].f741b[i2];
            }
        }
    }
    ...
    private static void a(java.lang.String r8, int r9, androidx.core.graphics.e.a r10) {
        /*
            r0 = 0
            r10.f739b = r0
            r1 = r9
        ...
        L_0x003d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.e.a(java.lang.String, int, androidx.core.graphics.e$a):void");
    }
    ...
    public static class b {
        ...
        b(b bVar) {
            this.f740a = bVar.f740a;
            float[] fArr = bVar.f741b;
            this.f741b = e.a(fArr, 0, fArr.length);
        }
        ...
        public static void a(b[] bVarArr, Path path) {
            ...
            char c = 'm';
            for (int i = 0; i < bVarArr.length; i++) {
                a(path, fArr, c, bVarArr[i].f740a, bVarArr[i].f741b);
                c = bVarArr[i].f740a;
            }
        }
        ...
        public void a(b bVar, b bVar2, float f) {
            ...
            while (true) {
                float[] fArr = bVar.f741b;
                if (i < fArr.length) {
                    this.f741b[i] = (fArr[i] * (1.0f - f)) + (bVar2.f741b[i] * f);
                    i++;
                } else {
                    return;
                }
        ...
        private static void a(android.graphics.Path r24, float[] r25, char r26, char r27, float[] r28) {
            ...
            L_0x0308:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.e.b.a(android.graphics.Path, float[], char, char, float[]):void");
        }
