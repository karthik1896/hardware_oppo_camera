...
public class k extends l {
    ...
    public android.graphics.Typeface a(android.content.Context r12, android.os.CancellationSignal r13, androidx.core.d.b.C0015b[] r14, int r15) {
        ...
        L_0x0009:
            ...
            r6 = r14[r3]
            android.net.Uri r7 = r6.a()     // Catch:{ IOException -> 0x006e }
        ...
        L_0x0020:
            ...
            int r9 = r6.c()     // Catch:{ Throwable -> 0x0057, all -> 0x0054 }
            android.graphics.fonts.Font$Builder r8 = r8.setWeight(r9)     // Catch:{ Throwable -> 0x0057, all -> 0x0054 }
            boolean r9 = r6.d()     // Catch:{ Throwable -> 0x0057, all -> 0x0054 }
        ...
        L_0x0084:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.k.a(android.content.Context, android.os.CancellationSignal, androidx.core.d.b$b[], int):android.graphics.Typeface");
    }
    ...
    public Typeface a(Context context, c.b bVar, Resources resources, int i) {
        ...
        int i5 = (i & 1) != 0 ? STStickerMakeupParamType.ST_STICKER_PARAM_MAKEUP_FLOAT_SCALE : 400;
        if ((i & 2) != 0) {
            i2 = 1;
        }
    ...
    public Typeface a(Context context, Resources resources, int i, String str, int i2) {
        try {
            return new Typeface.CustomFallbackBuilder(new FontFamily.Builder(new Font.Builder(resources, i).build()).build()).setStyle(new FontStyle((i2 & 1) != 0 ? STStickerMakeupParamType.ST_STICKER_PARAM_MAKEUP_FLOAT_SCALE : 400, (i2 & 2) != 0 ? 1 : 0)).build();
        } catch (IOException unused) {
            return null;
        }
    }
