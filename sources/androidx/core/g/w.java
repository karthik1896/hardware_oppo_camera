...
public final class w {
    ...
    private static Method f719a;

    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f719a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    private static float d(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f719a) != null) {
            try {
