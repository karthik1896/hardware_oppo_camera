...
public final class a {
    ...
    private final HashMap<BroadcastReceiver, ArrayList<b>> f803b = new HashMap<>();
    private final HashMap<String, ArrayList<b>> c = new HashMap<>();
    private final ArrayList<C0028a> d = new ArrayList<>();
    ...
    private static final class b {
        ...
        /* renamed from: a  reason: collision with root package name */
        final IntentFilter f807a;

        /* renamed from: b  reason: collision with root package name */
        final BroadcastReceiver f808b;
        boolean c;
        boolean d;

        b(IntentFilter intentFilter, BroadcastReceiver broadcastReceiver) {
            this.f807a = intentFilter;
            this.f808b = broadcastReceiver;
        }
    ...
    private static final class C0028a {
        ...
        /* renamed from: b  reason: collision with root package name */
        final ArrayList<b> f806b;

        C0028a(Intent intent, ArrayList<b> arrayList) {
            this.f805a = intent;
    ...
    public void a(BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        synchronized (this.f803b) {
            ...
            ArrayList arrayList = this.f803b.get(broadcastReceiver);
            if (arrayList == null) {
                arrayList = new ArrayList(1);
                this.f803b.put(broadcastReceiver, arrayList);
            }
            arrayList.add(bVar);
    ...
    public void a(BroadcastReceiver broadcastReceiver) {
        synchronized (this.f803b) {
            ArrayList remove = this.f803b.remove(broadcastReceiver);
            if (remove != null) {
                for (int size = remove.size() - 1; size >= 0; size--) {
                    b bVar = (b) remove.get(size);
                    bVar.d = true;
                    for (int i = 0; i < bVar.f807a.countActions(); i++) {
                        String action = bVar.f807a.getAction(i);
                        ArrayList arrayList = this.c.get(action);
                        if (arrayList != null) {
                            for (int size2 = arrayList.size() - 1; size2 >= 0; size2--) {
                                b bVar2 = (b) arrayList.get(size2);
                                if (bVar2.f808b == broadcastReceiver) {
                                    bVar2.d = true;
    ...
    public boolean a(android.content.Intent r22) {
        /*
            ...
            r1 = r21
            r0 = r22
            java.util.HashMap<android.content.BroadcastReceiver, java.util.ArrayList<androidx.e.a.a$b>> r2 = r1.f803b
            monitor-enter(r2)
            java.lang.String r10 = r22.getAction()     // Catch:{ all -> 0x0175 }
            android.content.Context r3 = r1.f802a     // Catch:{ all -> 0x0175 }
        ...
        L_0x0056:
            java.util.HashMap<java.lang.String, java.util.ArrayList<androidx.e.a.a$b>> r3 = r1.c     // Catch:{ all -> 0x0175 }
        ...
        L_0x0080:
            ...
            r5 = r3
            androidx.e.a.a$b r5 = (androidx.e.a.a.b) r5     // Catch:{ all -> 0x0175 }
            ...
            android.content.IntentFilter r9 = r5.f807a     // Catch:{ all -> 0x0175 }
            r4.append(r9)     // Catch:{ all -> 0x0175 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0175 }
            android.util.Log.v(r3, r4)     // Catch:{ all -> 0x0175 }
        L_0x00a7:
        ...
        L_0x00b4:
            ...
            goto L_0x0137
        L_0x00c0:
            android.content.IntentFilter r3 = r5.f807a     // Catch:{ all -> 0x0175 }
        ...
        L_0x0147:
            ...
            androidx.e.a.a$b r4 = (androidx.e.a.a.b) r4     // Catch:{ all -> 0x0175 }
            r5 = 0
            r4.c = r5     // Catch:{ all -> 0x0175 }
            int r3 = r3 + 1
            goto L_0x0147
        L_0x0159:
            java.util.ArrayList<androidx.e.a.a$a> r3 = r1.d     // Catch:{ all -> 0x0175 }
            androidx.e.a.a$a r4 = new androidx.e.a.a$a     // Catch:{ all -> 0x0175 }
        ...
        L_0x0175:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.e.a.a.a(android.content.Intent):boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0036, code lost:
        r6.f808b.onReceive(r9.f802a, r3.f805a);
     */
    ...
    public void a() {
        /*
            r9 = this;
        L_0x0000:
            java.util.HashMap<android.content.BroadcastReceiver, java.util.ArrayList<androidx.e.a.a$b>> r0 = r9.f803b
            monitor-enter(r0)
            java.util.ArrayList<androidx.e.a.a$a> r1 = r9.d     // Catch:{ all -> 0x0045 }
            int r1 = r1.size()     // Catch:{ all -> 0x0045 }
            if (r1 > 0) goto L_0x000d
            monitor-exit(r0)     // Catch:{ all -> 0x0045 }
            return
        L_0x000d:
            androidx.e.a.a$a[] r1 = new androidx.e.a.a.C0028a[r1]     // Catch:{ all -> 0x0045 }
            java.util.ArrayList<androidx.e.a.a$a> r2 = r9.d     // Catch:{ all -> 0x0045 }
        ...
        L_0x001c:
            ...
            r3 = r1[r2]
            java.util.ArrayList<androidx.e.a.a$b> r4 = r3.f806b
            int r4 = r4.size()
            r5 = r0
        L_0x0028:
            if (r5 >= r4) goto L_0x0042
            java.util.ArrayList<androidx.e.a.a$b> r6 = r3.f806b
            java.lang.Object r6 = r6.get(r5)
            androidx.e.a.a$b r6 = (androidx.e.a.a.b) r6
            boolean r7 = r6.d
            if (r7 != 0) goto L_0x003f
            android.content.BroadcastReceiver r6 = r6.f808b
            android.content.Context r7 = r9.f802a
            android.content.Intent r8 = r3.f805a
            r6.onReceive(r7, r8)
        L_0x003f:
            int r5 = r5 + 1
            goto L_0x0028
        ...
        L_0x0045:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.e.a.a.a():void");
    }
}
