...
public class e {
    ...
    private static class a implements TypeEvaluator<e.b[]> {
        ...
        public e.b[] evaluate(float f, e.b[] bVarArr, e.b[] bVarArr2) {
            if (androidx.core.graphics.e.a(bVarArr, bVarArr2)) {
                if (!androidx.core.graphics.e.a(this.f1327a, bVarArr)) {
                    this.f1327a = androidx.core.graphics.e.a(bVarArr);
                }
                for (int i = 0; i < bVarArr.length; i++) {
                    this.f1327a[i].a(bVarArr[i], bVarArr2[i], f);
                }
                return this.f1327a;
            }
    ...
    private static android.animation.PropertyValuesHolder a(android.content.res.TypedArray r11, int r12, int r13, int r14, java.lang.String r15) {
        ...
        L_0x003c:
            ...
            androidx.core.graphics.e$b[] r13 = androidx.core.graphics.e.b(r12)
            androidx.core.graphics.e$b[] r14 = androidx.core.graphics.e.b(r11)
        ...
        L_0x0054:
            ...
            boolean r3 = androidx.core.graphics.e.a((androidx.core.graphics.e.b[]) r13, (androidx.core.graphics.e.b[]) r14)
    ...
    private static void a(ValueAnimator valueAnimator, TypedArray typedArray, int i, float f, XmlPullParser xmlPullParser) {
        ...
        if (a2 != null) {
            ...
            a(androidx.core.graphics.e.a(a2), objectAnimator, f * 0.5f, a3, a4);
            return;
        }
    ...
    private static Keyframe a(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        if (z) {
            if (i == 0) {
                keyframe = Keyframe.ofFloat(a3, g.a(a2, xmlPullParser, Downloads.Impl.RequestHeaders.COLUMN_VALUE, 0, 0.0f));
            } else if (i == 1 || i == 3) {
                keyframe = Keyframe.ofInt(a3, g.a(a2, xmlPullParser, Downloads.Impl.RequestHeaders.COLUMN_VALUE, 0, 0));
            } else {
                keyframe = null;
            }
        } else if (i == 0) {
