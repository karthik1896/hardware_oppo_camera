...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        ar a2 = ar.a(context, attributeSet, R.styleable.SwitchCompat, i, 0);
        this.mThumbDrawable = a2.a(R.styleable.SwitchCompat_android_thumb);
        Drawable drawable = this.mThumbDrawable;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        this.mTrackDrawable = a2.a(R.styleable.SwitchCompat_track);
        Drawable drawable2 = this.mTrackDrawable;
        if (drawable2 != null) {
            drawable2.setCallback(this);
        }
        this.mTextOn = a2.c(R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = a2.c(R.styleable.SwitchCompat_android_textOff);
        this.mShowText = a2.a(R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = a2.e(R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = a2.e(R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = a2.e(R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = a2.a(R.styleable.SwitchCompat_splitTrack, false);
        ColorStateList e = a2.e(R.styleable.SwitchCompat_thumbTint);
        if (e != null) {
            this.mThumbTintList = e;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode a3 = aa.a(a2.a(R.styleable.SwitchCompat_thumbTintMode, -1), (PorterDuff.Mode) null);
        ...
        PorterDuff.Mode a4 = aa.a(a2.a(R.styleable.SwitchCompat_trackTintMode, -1), (PorterDuff.Mode) null);
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ar a2 = ar.a(context, i, R.styleable.TextAppearance);
        ...
        setSwitchTypefaceByIndex(a2.a(R.styleable.TextAppearance_android_typeface, -1), a2.a(R.styleable.TextAppearance_android_textStyle, -1));
    ...
    private void stopDrag(MotionEvent motionEvent) {
        ...
        if (z3) {
            ...
            if (Math.abs(xVelocity) > ((float) this.mMinFlingVelocity)) {
                if (!ax.a(this) ? xVelocity <= 0.0f : xVelocity >= 0.0f) {
                    z2 = false;
                }
                z = z2;
            } else {
    ...
    public void setChecked(boolean z) {
        super.setChecked(z);
        boolean isChecked = isChecked();
        if (getWindowToken() == null || !v.A(this)) {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            Rect a2 = aa.a(this.mThumbDrawable);
