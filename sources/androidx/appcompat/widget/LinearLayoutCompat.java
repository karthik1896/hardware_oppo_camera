...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        ar a2 = ar.a(context, attributeSet, R.styleable.LinearLayoutCompat, i, 0);
    ...
    public void drawDividersVertical(Canvas canvas) {
        ...
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            ...
            if (virtualChildAt2 == null) {
                ...
                i = virtualChildAt2.getBottom() + ((a) virtualChildAt2.getLayoutParams()).bottomMargin;
            }
    ...
    public void drawDividersHorizontal(Canvas canvas) {
        ...
        for (int i5 = 0; i5 < virtualChildCount; i5++) {
            ...
            if (!(virtualChildAt == null || virtualChildAt.getVisibility() == 8 || !hasDividerBeforeChildAt(i5))) {
                ...
                if (a2) {
                    i4 = virtualChildAt.getRight() + aVar.rightMargin;
                } else {
                    i4 = (virtualChildAt.getLeft() - aVar.leftMargin) - this.mDividerWidth;
                }
        ...
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            ...
            if (virtualChildAt2 != null) {
                ...
                if (a2) {
                    i3 = virtualChildAt2.getLeft() - aVar2.leftMargin;
    ...
    public void layoutVertical(int i, int i2, int i3, int i4) {
        ...
        while (i14 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                i5 = i17 + measuredHeight + aVar.bottomMargin + getNextLocationOffset(virtualChildAt);
                i6 = 1;
                i14 += i6;
            }
            i6 = 1;
    ...
    public void layoutHorizontal(int r25, int r26, int r27, int r28) {
        /*
            ...
            int r1 = androidx.core.g.v.g(r24)
            int r1 = androidx.core.g.c.a(r2, r1)
            r15 = 2
            r5 = 1
