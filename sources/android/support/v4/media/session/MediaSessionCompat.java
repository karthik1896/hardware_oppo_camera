    ...
    public static abstract class Callback {
        ...
        private class StubApi21 implements MediaSessionCompatApi21.Callback {
            ...
            public void onCommand(java.lang.String r5, android.os.Bundle r6, android.os.ResultReceiver r7) {
                ...
                L_0x002b:
                    androidx.core.app.d.a(r6, r2, r1)     // Catch:{ BadParcelableException -> 0x00c4 }
        ...
        private i.a mVolumeCallback = new i.a() {
            public void onVolumeChanged(i iVar) {
                if (MediaSessionImplBase.this.mVolumeProvider == iVar) {
                    MediaSessionImplBase.this.sendVolumeInfoChanged(new ParcelableVolumeInfo(MediaSessionImplBase.this.mVolumeType, MediaSessionImplBase.this.mLocalStream, iVar.b(), iVar.c(), iVar.a()));
                }
            }
        };
        i mVolumeProvider;
