                ...
                if (charAt < 128) {
                    ...
                    if (charAt < 2048) {
                        ...
                        if (charAt > 56319 || c < 56320 || c > 57343) {
                            ...
                            int i7 = (((charAt & 10239) << 10) | (9215 & c)) + STCommon.ST_MOBILE_TRACKING_SINGLE_THREAD;
                            writeByte((i7 >> 18) | 240);
        ...
        public final long expandBuffer(int i) {
            if (i <= 0) {
                ...
                if (buffer2 == null) {
                    ...
                    writableSegment.limit = OppoExifTag.EXIF_TAG_SUPER_HIGH_RESOLUTION;
                    long j2 = (long) i2;
                    ...
                    this.data = writableSegment.data;
                    this.start = 8192 - i2;
                    this.end = OppoExifTag.EXIF_TAG_SUPER_HIGH_RESOLUTION;
                    return j2;
                } else {
